 ...
 * only 78 distinct Korean characters — so the choice would be between shipping a FULL Korean face at roughly half a
 ...
 * `system-ui, sans-serif` resolves to a Latin face on plenty of devices, and then every Korean label is tofu — on
 * exactly the low-end hardware this project is for. The landing page already does this, and this is the same list.
 */
export const FONT_STACK =
  "system-ui, -apple-system, 'Apple SD Gothic Neo', 'Noto Sans KR', 'Malgun Gothic', " +
